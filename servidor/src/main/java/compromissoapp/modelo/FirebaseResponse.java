...
public class FirebaseResponse {
	...
	public String toString() {
		...
		resultado.append(FirebaseResponse.class.getSimpleName() + "[ ").append("(Sucesso:").append(this.sucesso)
				.append(") ").append("(Codigo:").append(this.codigo).append(") ").append("(Corpo:").append(this.corpo)
				.append(") ").append("(Corpo Bruto:").append(this.corpoBruto).append(") ").append("]");
